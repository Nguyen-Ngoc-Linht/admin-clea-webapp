<template>
  <div class="signup">
    <Navbar btn-background="bg-gradient-primary" class="mt-2" />

    <!-- Anhr nen -->
    <div
      class="pt-5 m-2 page-header align-items-start min-vh-50 pb-11 border-radius-lg"
      :style="{
        backgroundImage:
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="mx-auto text-center col-lg-5">
            <h1 class="mt-5 mb-2 text-white">CMS-Clea-Web-App!</h1>
            <p class="text-white text-lead">
              Nền tảng quản lý dữ liệu Clea-Web-App
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="card-body">
              <form role="form">
                ...
                <div class="text-center">
                  <button
                    class="btn mb-0 my-4 mb-2 bg-gradient-dark w-100"
                    type="submit"
                  >
                    Đăng ký
                    <slot />
